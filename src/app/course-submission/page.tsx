...
export default function CourseSubmissionPage() {
  ...
  return (
    <div className="bg-white  bg-gray-100  w-full pb-11 ">
        <div className=' container bg-white rounded-xl  px-8  pt-8 w-[100%] flex sm:justify-center lg:justify-start  gap-6 mx-auto'>
      ...
      <div className=" container bg-white rounded-xl  px-8  pt-3 w-[100%] flex  md:flex-row flex-col gap-6 mx-auto items-center">
        ...
        <div className="md:w-[50%] w-full  bg-white rounded-xl  p-6 flex flex-col items-center justify-center shadow-2xl">
