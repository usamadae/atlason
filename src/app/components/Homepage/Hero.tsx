            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="w-full md:w-1/2 text-white mb-8 md:mb-0">
                        <h1 className="text-5xl md:text-[72px] font-black mb-4 font-inter">
                            Learn With <span className="relative text-black">Expert<div className="absolute bottom-[-8px] left-0 w-full h-1 ">
                                <Image
                        ...
                        <h2 className="text-5xl leading-[92px] md:text-[72px] font-black mb-4 font-inter">
                            Any <span className="relative text-black ">Time
                                ...
                                </div></span> Any <br /> Where
                        </h2>
                        <p className="mb-8 text-sm md:text-[24px] font-inter font-normal">
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s
                        </p>
                        <button className="bg-white text-[#3DB765] px-6 py-3 text-[18px] font-inter font-semibold hover:bg-black cursor-pointer hover:text-white transition">
                            Create Account
                        </button>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 relative">
                        ...
                        {/* onlu icon notification */}
                        <div className="absolute top-[50px] right-[80px] flex items-center">
                            <div className="bg-[#3DB765] p-2 rounded-md mr-3">
                                ...
                                <svg width="69" height="70" viewBox="0 0 69 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M34.5 23.1826V47.3326" stroke="#3DB765" stroke-width="4" stroke-linecap="round" />
                                    <path d="M25.875 27.4951L25.875 47.3326" stroke="#3DB765" stroke-width="4" stroke-linecap="round" />
                                    <path d="M43.125 32.6701V47.3326" stroke="#3DB765" stroke-width="4" stroke-linecap="round" />
                                </svg>
                        ...
                        {/* Stats notification */}
                        <div className="absolute top-[125px] left-[-50px] bg-white opacity-[80%] rounded-[20px] px-5 py-3 shadow-md z-20 flex items-center">
                            <div className="bg-[#3DB765] p-2 rounded-md mr-3">
                                ...
                                <svg width="30" height="30" viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g clip-path="url(#clip0_156_9452)">
                            ...
                            <div>
                                <div className="font-bold text-black font-inter text-[20px] ">250k</div>
                                <div className="text-[16px] text-black font-inter font-semibold">Assisted Student</div>
                            </div>
                        </div>

                        {/* Congratulations notification */}
                        <div className="absolute top-[300px] right-0 md:right-16 bg-white opacity-[80%] rounded-[20px] px-5 py-3 shadow-md z-20 max-w-xs">
                            <div className="flex items-start">
                                ...
                                <div>
                                    <div className="font-bold text-[20px] font-inter flex items-center gap-2">
                                        Congratulations
                                        <span className="bg-green-100 text-green-600 p-1 rounded-full">

                                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="10" cy="10.3662" r="10" fill="#4EE381" />
                                                <path d="M6 11.0607L8.88679 14.3662L15 7.36621" stroke="white" stroke-width="2" stroke-linecap="round" />
                                            </svg>

                                        </span>
                                    </div>
                                    <div className="text-[16px] font-inter font-semibold">Your admission completed</div>
                                </div>
                            </div>
                        </div>

                        {/* Class notification */}
                        <div className="absolute bottom-32 left-0 md:left-[-50px] bg-white opacity-[80%] rounded-[20px] px-5 py-3 shadow-md z-20">
                            <div className="flex items-start">
                                <div className="mr-3">
                                ...
                                <div>
                                    <div className="font-bold text-[20px] font-inter">User Experience Class</div>
                                    <div className="text-[16px] font-inter font-semibold mb-2">Today at 12.00 PM</div>
                                    <Link href="#">
                                        <button className="bg-[#3DB765] text-white py-2 px-8 rounded-[80px] text-[16px] font-inter font-bold">
                                            Join Now
                                        </button>
                                    </Link>
                                </div>
